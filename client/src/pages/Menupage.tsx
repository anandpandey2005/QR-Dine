...
import { Advertisementbanner, CategoryChip } from "../components";
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <select
                name="sortBy"
                id="sortBy"
                className="appearance-none bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent block w-full p-2.5 pr-10 outline-none transition-all cursor-pointer hover:bg-gray-100"
              >
